...
\begin{DoxyCode}
213       : loglikelyRecord(param.loglikelyRecord)
214       , fn(param.fn)
215       , fp(param.fp)
216       , thread(param.thread)
217       , iterNum(param.iterNum)
218       , drugNum(param.drugNum)
219       , subNum(param.subNum)
220       , domainNum(param.domainNum)
221       , proteinNum(param.proteinNum)
222       , task(param.task)
223       , drug2sub(&\hyperlink{namespacegift_a73506f6b6bc3e6f6fedfacf8bf0d38f1}{drug2subList})
224       , sub2drug(&\hyperlink{namespacegift_afcc3e6429fa4fef47fb34e30d2f0c6c4}{sub2drugList})
225       , protein2sub(&\hyperlink{namespacegift_aa113a7a90b1c3c70d1ab252eb34816fe}{protein2domainList})
226       , sub2protein(&\hyperlink{namespacegift_ac99bcb1b736637f97e82be7503c725b5}{domain2proteinList})
227       , drug2protein(&\hyperlink{namespacegift_a2c0005015565d7432dd64fd6bafd3395}{drug2proteinList})
228       , drugSub2proteinSub(&\hyperlink{namespacegift_ae49d782c144d39543cd6504f5e7d9c7a}{drugSub2proteinSubMatrix})
229       , observedDrug2Protein(&\hyperlink{namespacegift_ad84dd6f05c58f2f2061db7ab70bd5471}{observedDrug2ProteinMatrix})
230       , vardrugSub2proteinSub(&\hyperlink{namespacegift_a7191203810c7c52faceb69ac903e7899}{vardrugSub2proteinSubMatrix})
231       , loglikely(&\hyperlink{namespacegift_ac31667d9b67b35a70ac9d46dfe6a7967}{loglikelyArray})
232       , predictDrugsFileName(param.predictDrugsFileName)
233       , predictProteinsFileName(param.predictProteinsFileName)
234       , predictDrugsFileName\_WithSubs(param.predictDrugsFileName\_WithSubs)
235       , predictProteinsFileName\_WithSubs(param.predictProteinsFileName\_WithSubs)
236       , outputDelims(param.outputDelims)
237       , outRecordFileName(param.outRecordFileName)
238       , outPredictCPIsFileName(param.outPredictCPIsFileName)
239       , outDrugSub2ProteinSubFileName(param.outDrugSub2ProteinSubFileName)
240       , outVarDrugSub2proteinSubFileName(param.outVarDrugSub2proteinSubFileName)
241     \{ \} \textcolor{comment}{// end of constuctor.}
\end{DoxyCode}
...
\begin{DoxyCode}
243 \{ \} \textcolor{comment}{// end of default destruction.}
\end{DoxyCode}
...
269                                                             \{
270       boost::thread *y;
271       boost::thread\_group * x = \textcolor{keyword}{new} boost::thread\_group;
272       \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i=0;i<thread;++i)\{
273         y = \textcolor{keyword}{new} boost::thread(\textcolor{keyword}{function},\textcolor{keyword}{this},i);
274         x->add\_thread(y);
275       \} \textcolor{comment}{// end of loop for i}
276       x->join\_all();
277       \textcolor{keyword}{delete} x;
278       \textcolor{keywordflow}{return} 0;
279     \} \textcolor{comment}{// end of function.}
\end{DoxyCode}
...
\begin{DoxyCode}
288                                              \{
289       (*loglikely).push\_back(logscore);
290       \textcolor{keywordflow}{return} 0;
291     \} \textcolor{comment}{// end of function}
\end{DoxyCode}
...
\begin{DoxyCode}
253                                                           \{
254       drug2protein = &d2p;
255       \textcolor{keywordflow}{return} 0;
256     \} \textcolor{comment}{// end of func}
\end{DoxyCode}
...
248     \} \textcolor{comment}{// end of func}
\end{DoxyCode}
...
\begin{DoxyCode}
257                                                                    \{
258       drugSub2proteinSub = &ds2ps;
259       \textcolor{keywordflow}{return} 0;
260     \} \textcolor{comment}{// end of func}
\end{DoxyCode}
...
252     \} \textcolor{comment}{// end of func}
\end{DoxyCode}
